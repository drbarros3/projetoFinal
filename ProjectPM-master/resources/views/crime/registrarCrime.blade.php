...
@section('body')
    ...
    @csrf
            ...
            <div class="nomesus {{ $errors->has('sus') ? 'has->error' : '' }}">
                ...
                <input type="text" class="form-control" name="susp" id="susp"  value="{{$crime->suspeito}}">
                @if($errors->has('sus'))
            ...
            <input type="hidden" name="id" value="{{$crime->id_suspeito}}">
            ...
            <div class="comparsa {{ $errors->has('comdutor') ? 'has->error' : '' }} ">
                ...
                <div class="btnsus">
                    <button id="btnsus" type="submit" class="btn btn-primary">Registrar</button>
                </div>
            </div>
    </form>
@endsection('body')